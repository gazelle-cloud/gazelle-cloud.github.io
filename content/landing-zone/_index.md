...
- **Configurable Address Space**: The default virtual network address space is /24, supporting 255 IPs. This can be customized when requesting a new landing zone.
...
- **Subscription-Level Billing**: Subscription usage charges are linked directly to the associated application `invoice section`, enabling tracking cost per environment (e.g., dev, test, prod).
